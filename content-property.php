        ...
        <div class="border bg-white mb-3">
                            ...
                            if ( ! empty( $property_location ) ) {
                                if ( ! is_wp_error( $property_location ) ) {
                                    echo '<div class="property-location">';
                                        echo '<span class="pe-2">' . velocitychild_get_bootstrap_icon_html('geo-alt') . '</span>';
                ...
                <div class="row m-0 py-3">
                    <div class="col-12 mb-2">
                        <?php
                        $single_image = get_the_post_thumbnail_url($post->ID, 'full');
                        if (empty($single_image)) {
                            $single_image = velocitychild_get_no_image_url();
                        }
                        ?>
                        <img class="w-100" src="<?php echo esc_url($single_image); ?>" alt="<?php echo esc_attr(get_the_title()); ?>">
                    </div>
                    <div class="col-12">
                        <small>Tayang sejak <?php the_time('d-m-Y'); ?></small>
